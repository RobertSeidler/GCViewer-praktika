...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Fr. Apr 26 12:15:31 2013
...
INCPATH       = -I/usr/share/qt4/mkspecs/default -I. -I/usr/include/QtCore -I/usr/include/QtGui -I/usr/include/QtOpenGL -I/usr/include -I/usr/X11R6/include -Imoc
LINK          = g++
LFLAGS        = -m64
LIBS          = $(SUBLIBS)  -L/usr/lib64 -L/usr/X11R6/lib64 -lGLEW -fopenmp -lQtOpenGL -L/usr/lib64 -L/usr/X11R6/lib64 -lQtGui -lQtCore -lGLU -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
Makefile: CGViewer.pro  /usr/share/qt4/mkspecs/default/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
		/usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/qconfig.pri \
		/usr/share/qt4/mkspecs/modules/qt_phonon.pri \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/CGViewer1.0.0/ && $(COPY_FILE) --parents main.h gui.h CGMath.h Matrix.h Model.h Scene.h EditWidgets.h Light.h SaveSceneDialog.h Raytracer.h ShaderStuff.h obj/CGViewer1.0.0/ && $(COPY_FILE) --parents main.cpp gui.cpp Matrix.cpp Model.cpp Scene.cpp EditWidgets.cpp Light.cpp SaveSceneDialog.cpp Raytracer.cpp ShaderStuff.cpp obj/CGViewer1.0.0/ && (cd `dirname obj/CGViewer1.0.0` && $(TAR) CGViewer1.0.0.tar CGViewer1.0.0 && $(COMPRESS) CGViewer1.0.0.tar) && $(MOVE) `dirname obj/CGViewer1.0.0`/CGViewer1.0.0.tar.gz . && $(DEL_FILE) -r obj/CGViewer1.0.0
...
moc/moc_gui.cpp: Scene.h \
		...
		SaveSceneDialog.h \
		gui.h
	/usr/bin/moc $(DEFINES) $(INCPATH) gui.h -o moc/moc_gui.cpp

moc/moc_Scene.cpp: ShaderStuff.h \
		Model.h \
		Matrix.h \
		CGMath.h \
		Light.h \
		...
		SaveSceneDialog.h \
		Scene.h
	/usr/bin/moc $(DEFINES) $(INCPATH) Scene.h -o moc/moc_Scene.cpp

moc/moc_EditWidgets.cpp: Light.h \
		CGMath.h \
		Matrix.h \
		EditWidgets.h
	/usr/bin/moc $(DEFINES) $(INCPATH) EditWidgets.h -o moc/moc_EditWidgets.cpp

moc/moc_SaveSceneDialog.cpp: CGMath.h \
		SaveSceneDialog.h
	/usr/bin/moc $(DEFINES) $(INCPATH) SaveSceneDialog.h -o moc/moc_SaveSceneDialog.cpp

moc/moc_Raytracer.cpp: CGMath.h \
		Raytracer.h
	/usr/bin/moc $(DEFINES) $(INCPATH) Raytracer.h -o moc/moc_Raytracer.cpp
